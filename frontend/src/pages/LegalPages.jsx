...
export function TermsPage() {
  return <Legal eyebrow="Terms" title="Terms of Service" intro="Realistic platform rules for guests, hosts, payments, and acceptable use." sections={[
    ...
    ['Cancellation policy', 'Cancellations may create fees based on timing, host preparation, and payment status. Host cancellations can affect acceptance metrics and superhost eligibility.'],
    ...
    ['Payment terms', 'Wallet credits, simulated card/UPI payments, refunds, host earnings, platform fees, and payout holds are recorded in platform ledgers.'],
    ['Host responsibilities', 'Hosts must provide roadworthy cars, accurate listings, valid ownership details, clean interiors, timely handover, and truthful condition reporting.'],
...
export function PrivacyPage() {
  return <Legal eyebrow="Privacy" title="Privacy Policy" intro="How the clone collects, uses, shares, and protects platform data." sections={[
    ...
    ['Sharing', 'Relevant trip details are shared between guest and host. Admins can access operational data. Service providers may process email, storage, analytics, and infrastructure events.'],
...
export function RefundPage() {
  return <Legal eyebrow="Refunds" title="Refund Policy" intro="Cancellation tiers, wallet timelines, deposits, and insurance claim treatment." sections={[
    ['Cancellation tiers', 'Early cancellations generally receive larger refunds. Close-to-pickup or no-show cancellations may retain platform fees or host compensation.'],
