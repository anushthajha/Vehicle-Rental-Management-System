...
export default function HostDashboardPage() {
  ...
  return <div className="px-4 py-8"><section className="mx-auto max-w-7xl space-y-6"><div className="flex flex-wrap items-center justify-between gap-3"><div><p className="text-sm font-black uppercase text-zoomcar">Host Dashboard</p><h1 className="text-3xl font-black">Your hosting cockpit</h1></div><div className="flex gap-2"><Link to="/host/cars/new" className="inline-flex items-center gap-2 rounded-md bg-zoomcar px-4 py-3 font-black text-white"><Plus size={18} /> List New Car</Link><Link to="/host/payouts" className="rounded-md bg-zinc-950 px-4 py-3 font-black text-white">Withdraw Earnings</Link></div></div>
