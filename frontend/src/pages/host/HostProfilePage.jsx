...
export default function HostProfilePage() {
  ...
  return <div className="px-4 py-8"><section className="mx-auto max-w-5xl space-y-6"><div><p className="text-sm font-black uppercase text-sigfleet">Manager Profile</p><h1 className="text-3xl font-black">Public hosting profile</h1></div>
