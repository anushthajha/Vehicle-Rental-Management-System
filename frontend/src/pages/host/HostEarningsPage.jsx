...
export default function HostEarningsPage() {
  ...
  const sortedCars = useMemo(() => cars.slice().sort((a, b) => Number(b[sort] || 0) - Number(a[sort] || 0)), [cars, sort])
