...
function FAQ() {
  const questions = [
    ...
    ['How do hosts get paid?', 'Host earnings are credited after successful trip completion. Hosts can request payouts to a verified bank account from the manager dashboard.'],
  ]
