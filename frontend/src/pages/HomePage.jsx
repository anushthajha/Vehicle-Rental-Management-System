...
export default function HomePage() {
  ...
  return (
    <main id="main-content" className="bg-[#F9FAFB] text-[#111827] dark:bg-gray-900 dark:text-gray-100">
      <Helmet>
        <title>Zoomcar Clone — Self-Drive Car Rentals</title>
        <meta name="description" content="Rent self-drive cars across 100+ Indian cities. Verified hosts, comprehensive insurance, instant booking." />
      </Helmet>
      <Navbar />
