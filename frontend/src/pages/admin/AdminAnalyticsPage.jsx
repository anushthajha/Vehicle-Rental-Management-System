...
export default function AdminAnalyticsPage() {
  ...
  return <div className="space-y-5">
    ...
    <section className="grid gap-5 xl:grid-cols-2">
      ...
      <ChartBox title="Vehicle Category Distribution"><ResponsiveContainer width="100%" height={260}><PieChart><Pie data={data.categories} dataKey="value" outerRadius={95} label>{data.categories.map((entry, index) => <Cell key={entry.name} fill={colors[index % colors.length]} />)}</Pie><Tooltip /></PieChart></ResponsiveContainer></ChartBox>
