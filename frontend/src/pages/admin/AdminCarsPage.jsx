    ...
    <div className="space-y-5">
      ...
      <div className="overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-sm">
        <table className="w-full min-w-[1000px] text-left text-sm">
          <thead className="bg-zinc-50 text-xs uppercase text-zinc-500"><tr><th className="p-4">Car</th><th className="p-4">Host</th><th className="p-4">Category</th><th className="p-4">Price/day</th><th className="p-4">Trips</th><th className="p-4">Status</th><th className="p-4">Listed</th><th className="p-4">Actions</th></tr></thead>
          <tbody>{cars.map((car) => <tr key={car.id} className="border-t border-zinc-100">
            ...
            <td className="p-4 font-bold">{car.host.name}</td><td className="p-4 capitalize">{car.category}</td><td className="p-4 font-black">{formatMoney(car.price_per_day)}</td><td className="p-4">{car.trips}</td><td className="p-4"><Badge value={car.status} /></td><td className="p-4">{formatDate(car.listed_date)}</td>
