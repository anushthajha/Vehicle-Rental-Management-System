...
class ManagerProfile(Base):
    ...
    @property
    def joined_as_host_at(self) -> DateTime:
        return self.assigned_at

    @joined_as_host_at.setter
    def joined_as_host_at(self, value: DateTime) -> None:
        self.assigned_at = value


HostProfile = ManagerProfile
